...
import { spikeTestThresholds } from '../../config/thresholds.js';
import { createBooking, getBookingById } from '../../utils/api/booking.js';

export const options = {
  scenarios: {
    spike_j2_create_reservation: { ...spikeTestOptions },
  },
...
export function handleSummary(data) {
  return {
    'reports/spike/j2-create-reservation-report.html': htmlReport(data),
